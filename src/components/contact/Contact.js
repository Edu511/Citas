...
export default class Contact extends Component {
  ...
  onFileUpload(){
    ...
    console.log(this.state.fileDocumento)
    // crea un objeto formData para guardar el archivo
    // const formData = new FormData();

    // Update the formData object
    // formData.append(
    //   // "doc_identificacion_" + this.state.txtCurp,
    //   "doc_identificacion_",
    //   this.state.fileDocumento,
    //   this.state.fileDocumento.name
    // );
    ...
    if (this.state.fileDocumento) {
      return (
        <div>
          ...
          <p>File Name: {this.state.fileDocumento.name}</p>

          <p>File Type: {this.state.fileDocumento.type}</p>

          <p>
            Last Modified:{" "}
            {this.state.fileDocumento.lastModifiedDate.toDateString()}
          </p>
        </div>
      );
    } else {
              ...
              <div className="row">
                <div className="col-md-6">
                  ...
                  <div className="form-group mb-3">
                    <label>
                      <input
                        ...
                        id="swAnonimo"
                        name="swAnonimo"
                        value={this.state.swAnonimo}
                        ref={(swAnonimo) => (this.inputSwAnonimo = swAnonimo)}
                      />
                  ...
                  <div className="form-group mb-3">
                    <label>
                      <input
                        onChange={this.checkF.bind(this)}
                        type="checkbox"
                        id="raPersona"
                        name="raPersona"
                        value={this.state.raPersona}
                        ref={(raPersona) => (this.inputRaPersona = raPersona)}
                        checked={
                          this.state.raPersona === "Fisica" ? true : false
                        }
                      />
                      <span>Fisica &nbsp; &nbsp;</span>
                    </label>
                    <label>
                      <input
                        onChange={this.checkM.bind(this)}
                        type="checkbox"
                        id="raPersona"
                        name="raPersona"
                        value={this.state.raPersona}
                        ref={(raPersona) => (this.inputRaPersona = raPersona)}
                        checked={
                          this.state.raPersona === "Moral" ? true : false
                        }
                      />
                      <span>Moral</span>
                    </label>
                  ...
                  <div className="form-group mb-3">
                    ...
                    <select
                      ...
                      id="selClasPersona"
                      name="selClasPersona"
                      value={this.state.selClasPersona}
                      ref={(selClasPersona) =>
                        (this.inputSelClasPersona = selClasPersona)
                      }
                    >
                      <option value="defaultClasificacionPersona">
                      ...
                      <option value="Victima Indirecta">
                        Victima Indirecta
                      </option>
                    </select>
                  </div>
                  ...
                  <div className="form-group mb-3">
                    ...
                    <input
                      ...
                      ref={(txtNombre) => (this.inputTxtNombre = txtNombre)}
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    ...
                    <input
                      ...
                      name="txtRFC"
                      placeholder="RFC"
                      value={this.state.txtRFC}
                      ref={(txtRFC) => (this.inputTxtRFC = txtRFC)}
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    ...
                    <input
                      ...
                      value={this.state.txtRazonSocial}
                      ref={(txtRazonSocial) =>
                        (this.inputTxtRazonSocial = txtRazonSocial)
                      }
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    ...
                    <input
                      ...
                      name="txtApPaterno"
                      value={this.state.txtApPaterno}
                      ref={(txtApPaterno) =>
                        (this.inputTxtApPaterno = txtApPaterno)
                      }
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    ...
                    <input
                      ...
                      ref={(txtAlias) => (this.inputTxtAlias = txtAlias)}
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    ...
                    <input
                      ...
                      id="dateFNacimiento"
                      className="form-control"
                      name="dateFNacimiento"
                      value={this.state.dateFNacimiento}
                      ref={(dateFNacimiento) =>
                        (this.inputDateFNacimiento = dateFNacimiento)
                      }
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    ...
                    <select
                      ...
                      id="selSexo"
                      name="selSexo"
                      value={this.state.selSexo}
                      ref={(selSexo) => (this.inputSelSexo = selSexo)}
                    >
                ...
                <div className="col-md-6">
                  ...
                  <div className="form-group mb-3">
                    <select
                      onChange={this.handlerOnChange}
                      className="form-select"
                      id="selEntidadFederativa"
                      name="selEntidadFederativa"
                      value={this.state.selEntidadFederativa}
                      ref={(selEntidadFederativa) =>
                        (this.inputSelEntidadFederativa = selEntidadFederativa)
                      }
                    >
                      <option value="defaultEntidadFederativa">
                  ...
                  <div className="form-group mb-3">
                    ...
                    <select
                      onChange={this.handlerOnChange}
                      className="form-select"
                      id="selIdentificacion"
                      name="selIdentificacion"
                      value={this.state.selIdentificacion}
                      ref={(selIdentificacion) =>
                        (this.inputSelIdentificacion = selIdentificacion)
                      }
                    >
                      <option value="defaultDocumentoIdentificacion">
                        Documento de Identificación
                      </option>
                      <option value="INE">INE</option>
                      <option value="LicenciaConducir">
                        Licencia de Conducir
                      </option>
                      <option value="Pasaporte">Pasaporte</option>
                      <option value="CedulaProfesional">
                        Cédula Profesional
                      </option>
                      <option value="CartillaMilitar">
                        Cartilla del Servicio Militar Nacional
                      </option>
                      <option value="CredencialLaboral">
                        Credencial de Identificacion Laboral
                      </option>
                      <option value="CredencialDerechohab">
                  ...
                  <div className="form-group mb-3">
                    <div className="mb-3 w-100">
                      ...
                      <input
                        ...
                        placeholder="CURP"
                        name="txtCurp"
                        value={this.state.txtCurp}
                        ref={(txtCurp) => (this.inputTxtCurp = txtCurp)}
                      />
                    </div>
                  </div>
                </div>
              ...
              <div className="row mb-3">
                ...
                >
                  <button
                    ...
                    onClick={this.siguiente.bind(this)}
                ...
                <div className="col-md-6">
                  <div className="form-group mb-3">
                    <select
                      ...
                      className="form-select"
                      id="selNotificacion"
                      name="selNotificacion"
                      value={this.state.selNotificacion}
                      ref={(selNotificacion) =>
                        (this.inputSelNotificacion = selNotificacion)
                      }
                    >
                      <option value="defaultMedioNotificacion">
                  ...
                  <div className="form-group mb-3">
                    <input
                      ...
                      name="txtnumTel1"
                      value={this.state.txtnumTel1}
                      ref={(txtnumTel1) => (this.inputTxtnumTel1 = txtnumTel1)}
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    <input
                      ...
                      name="txtnumTel2"
                      value={this.state.txtnumTel2}
                      ref={(txtnumTel2) => (this.inputTxtnumTel2 = txtnumTel2)}
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    <input
                      ...
                      name="emailCorreo"
                      value={this.state.emailCorreo}
                      ref={(emailCorreo) =>
                        (this.inputEmailCorreo = emailCorreo)
                      }
                    />
                    <span
                  ...
                  <div className="form-group mb-3">
                    <input
                      ...
                      value={this.state.txtNacionalidad}
                      ref={(txtNacionalidad) =>
                        (this.inputTxtNacionalidad = txtNacionalidad)
                      }
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    ...
                    <select
                      ...
                      id="selEstadoCivil"
                      name="selEstadoCivil"
                      value={this.state.selEstadoCivil}
                      ref={(selEstadoCivil) =>
                ...
                <div className="col-md-6">
                  <div className="form-group mb-3">
                    ...
                    <select
                      ...
                      id="selOcupacion"
                      name="selOcupacion"
                      value={this.state.selOcupacion}
                      ref={(selOcupacion) =>
                        (this.inputSelOcupacion = selOcupacion)
                      }
                    >
                  ...
                  <div className="form-group mb-3">
                    ...
                    <select
                      ...
                      className="form-select"
                      id="selNivelEstudios"
                      name="selNivelEstudios"
                      value={this.state.selNivelEstudios}
                      ref={(selNivelEstudios) =>
                        (this.inputSelNivelEstudios = selNivelEstudios)
                      }
                    >
                      <option value="defaultNivelEstudios">
                        Nivel de estudios
                      </option>
                      <option value="Preescolar Incompleta">
                        Preescolar Incompleta
                      </option>
                  ...
                  <div className="form-group mb-3">
                    ...
                    <select
                      ...
                      id="selLengua"
                      name="selLengua"
                      value={this.state.selLengua}
                      ref={(selLengua) => (this.inputSelLengua = selLengua)}
                    >
                  ...
                  <div className="form-group mb-3">
                    ...
                    <select
                      ...
                      id="selReligion"
                      name="selReligion"
                      value={this.state.selReligion}
                      ref={(selReligion) =>
                        (this.inputSelReligion = selReligion)
                      }
                    >
                  ...
                  <div className="form-group mb-3">
                    ...
                    <div className="form-group mb-3">
                      ...
                      <select
                        ...
                        id="selLGBT"
                        name="selLGBT"
                        value={this.state.selLGBT}
                        ref={(selLGBT) => (this.inputSelLGBT = selLGBT)}
                      >
                  ...
                  <div className="form-group mb-3">
                    <div className="form-group mb-3">
                      <label>
                        <input
                          ...
                          id="swDiscapacidad"
                          name="swDiscapacidad"
                          value={this.state.swDiscapacidad}
                          ref={(swDiscapacidad) =>
                            (this.inputSwDiscapacidad = swDiscapacidad)
                          }
                        />
                    ...
                    <div className="form-group mb-3">
                      ...
                      <select
                        ...
                        className="form-select"
                        id="selDiscapacidad"
                        name="selDiscapacidad"
                        value={this.state.selDiscapacidad}
                        ref={(selDiscapacidad) =>
                          (this.inputSelDiscapacidad = selDiscapacidad)
                        }
                      >
                        <option value="defaultDiscapacidad">
                          Seleccione...
                        </option>
                        ...
                        <option value="Discapacidad Fisica">
                          Discapacidad Fisica
                        </option>
                        <option value="Enfermedades Mentales">
                          Enfermedades Mentales
                        </option>
                        <option value="Transtorno del Lenguaje">
                          Transtorno del Lenguaje
                        </option>
                        <option value="Dificutades en el Aprendizaje">
                          Dificutades en el Aprendizaje
                        </option>
                        <option value="Enfermedad Cronica">
                          Enfermedad Cronica
                        </option>
                        ...
                        <option value="Perdida de Memoria">
                          Perdida de Memoria
                        </option>
              ...
              <div className="row mb-3">
                ...
                >
                  <button
                    ...
                    onClick={this.anterior.bind(this)}
                    style={{ marginLeft: "10px" }}
                  >
                    ANTERIOR
                  </button>
                ...
                <div className="col-md-6">
                  <div className="form-group mb-3">
                    ...
                    <select
                      ...
                      id="selTipoDelito"
                      name="selTipoDelito"
                      value={this.state.selTipoDelito}
                      ref={(selTipoDelito) =>
                        (this.inputSelTipoDelito = selTipoDelito)
                      }
                      aria-label="Tipo de delito"
                    >
                      <option value="defaultTipoDelito">Tipo de delito</option>
                      <option value="ABORTO">ABORTO</option>
                      <option value="COHECHO DE PARTICULARES">
                        COHECHO DE PARTICULARES
                      </option>
                      <option value="DELITOS COMETIDOS EN EL EJERCICIO DE UNA ACTIVIDAD PROFESIONAL O TÉCNICA">
                        DELITOS COMETIDOS EN EL EJERCICIO DE UNA ACTIVIDAD
                        PROFESIONAL O TÉCNICA
                      </option>
                      <option value="DELITOS CONTRA EL RESPETO A LOS MUERTOS Y CONTRA LAS NORMAS DE INHUMACIÓN Y EXHUMACIÓN">
                        PORTACION, FABRICACIÓN Y ACOPIO DE ARMAS PROHIBIDAS
                      </option>
                      <option value="DELITOS CONTRA EL RESPETO A LOS MUERTOS Y CONTRA LAS NORMAS DE INHUMACIÓN Y EXHUMACIÓN">
                        DELITOS CONTRA EL RESPETO A LOS MUERTOS Y CONTRA LAS
                        NORMAS DE INHUMACIÓN Y EXHUMACIÓN
                      </option>
                      <option value="VIOLENCIA FAMILIAR">
                        VIOLENCIA FAMILIAR
                      </option>
                      <option value="ABANDONO DE ATROPELLADO">
                      ...
                      <option value="REVELACIÓN DE SECRETO">
                        REVELACIÓN DE SECRETO
                      </option>
                      <option value="DELITOS EN CONTRA DE LOS ANIMALES">
                        DELITOS EN CONTRA DE LOS ANIMALES{" "}
                      </option>
                      <option value="DELITOS CONTRA EL TRABAJO Y LA PREVISIÓN SOCIAL">
                        DELITOS CONTRA EL TRABAJO Y LA PREVISIÓN SOCIAL
                      </option>
                      <option value="ASALTO EN NEGOCIO U OFICINA">
                        ASALTO EN NEGOCIO U OFICINA
                      </option>
                      <option value="ASALTO EN VEHÍCULO PARTICULAR">
                        ASALTO EN VEHÍCULO PARTICULAR
                      </option>
                      <option value="ASALTO EN CASA HABITACIÓN">
                        ASALTO EN CASA HABITACIÓN
                      </option>
                      <option value="ASALTO EN ESPACIO ABIERTO AL PÚBLICO">
                        ASALTO EN ESPACIO ABIERTO AL PÚBLICO
                      </option>
                      <option value="ASALTO EN TRANSPORTE PÚBLICO">
                        ASALTO EN TRANSPORTE PÚBLICO
                      </option>
                      <option value="ROBO A INSTITUCIONES BANCARIAS SIN VIOLENCIA">
                        ROBO A INSTITUCIONES BANCARIAS SIN VIOLENCIA
                      </option>
                      <option value="ROBO A TRANSEÚNTE SIN VIOLENCIA">
                        ROBO A TRANSEÚNTE SIN VIOLENCIA
                      </option>
                      <option value="ROBO A DEPENDENCIAS DE GOBIERNO CON VIOLENCIA">
                        ROBO A DEPENDENCIAS DE GOBIERNO CON VIOLENCIA
                      </option>
                      <option value="ROBO A PERSONA EN LUGAR PRIVADO CON VIOLENCIA">
                        ROBO A PERSONA EN LUGAR PRIVADO CON VIOLENCIA
                      </option>
                      <option value="ROBO A ESCUELAS SIN VIOLENCIA">
                        ROBO A ESCUELAS SIN VIOLENCIA
                      </option>
                      <option value="ROBO DE AUTOPARTES CON VIOLENCIA">
                        ROBO DE AUTOPARTES CON VIOLENCIA
                      </option>
                      <option value="ROBO A CASA HABITACIÓN CON VIOLENCIA">
                        ROBO A CASA HABITACIÓN CON VIOLENCIA
                      </option>
                      <option value="ROBO A IGLESIAS SIN VIOLENCIA">
                        ROBO A IGLESIAS SIN VIOLENCIA
                      </option>
                      <option value="ROBO A DEPENDENCIAS DE GOBIERNO SIN VIOLENCIA">
                        ROBO A DEPENDENCIAS DE GOBIERNO SIN VIOLENCIA
                      </option>
                      <option value="ROBO EN AUTOBUSES SIN VIOLENCIA">
                        ROBO EN AUTOBUSES SIN VIOLENCIA
                      </option>
                      <option value="ROBO A MAQUINARIA SIN VIOLENCIA">
                        ROBO A MAQUINARIA SIN VIOLENCIA
                      </option>
                      <option value="ROBO A ESCUELAS CON VIOLENCIA">
                        ROBO A ESCUELAS CON VIOLENCIA
                      </option>
                      <option value="ROBO A CUENTAHABIENTE SIN VIOLENCIA">
                        ROBO A CUENTAHABIENTE SIN VIOLENCIA
                      </option>
                      <option value="ROBO EN TRANSPORTE DE SERVICIO PUBLICO INDIVIDUAL SIN VIOLENCIA">
                        ROBO EN TRANSPORTE DE SERVICIO PUBLICO INDIVIDUAL SIN
                        VIOLENCIA
                      </option>
                      <option value="ROBO EN TRANSPORTE DE SERVICIO PUBLICO COLECTIVO SIN VIOLENCIA">
                        ROBO EN TRANSPORTE DE SERVICIO PUBLICO COLECTIVO SIN
                        VIOLENCIA
                      </option>
                      <option value="ROBO A MAQUINARIA CON VIOLENCIA">
                        ROBO A MAQUINARIA CON VIOLENCIA
                      </option>
                      <option value="ROBO EN VEHÍCULO DE PARTICULARES SIN VIOLENCIA">
                        ROBO EN VEHÍCULO DE PARTICULARES SIN VIOLENCIA
                      </option>
                      <option value="ROBO DE CAMIONES DE CARGA SIN VIOLENCIA">
                        ROBO DE CAMIONES DE CARGA SIN VIOLENCIA
                      </option>
                      <option value="ROBO OTRO TIPO SIN VIOLENCIA">
                        ROBO OTRO TIPO SIN VIOLENCIA
                      </option>
                      <option value="ROBO DE HIDROCARBURO SIN VIOLENCIA">
                        ROBO DE HIDROCARBURO SIN VIOLENCIA
                      </option>
                      <option value="ROBO A TRANSEÚNTE EN ESPACIO ABIERTO AL PUBLICO CON VIOLENCIA">
                        ROBO A TRANSEÚNTE EN ESPACIO ABIERTO AL PUBLICO CON
                        VIOLENCIA
                      </option>
                      <option value="ROBO A INSTITUCIONES DE SALUD CON VIOLENCIA">
                        ROBO A INSTITUCIONES DE SALUD CON VIOLENCIA
                      </option>
                      <option value="ROBO A NEGOCIO U OFICINA CON VIOLENCIA">
                        ROBO A NEGOCIO U OFICINA CON VIOLENCIA
                      </option>
                      <option value="ROBO A TRANSEÚNTE EN VÍA PUBLICA SIN VIOLENCIA">
                        ROBO A TRANSEÚNTE EN VÍA PUBLICA SIN VIOLENCIA
                      </option>
                      <option value="ROBO A NEGOCIO U OFICINA SIN VIOLENCIA">
                        ROBO A NEGOCIO U OFICINA SIN VIOLENCIA
                      </option>
                      <option value="ROBO A CASA HABITACIÓN SIN VIOLENCIA">
                        ROBO A CASA HABITACIÓN SIN VIOLENCIA
                      </option>
                      <option value="ROBO A TRANSPORTISTAS CON VIOLENCIA">
                        ROBO A TRANSPORTISTAS CON VIOLENCIA
                      </option>
                      <option value="ROBO A VEHÍCULO CON VIOLENCIA">
                        ROBO A VEHÍCULO CON VIOLENCIA
                      </option>
                      <option value="ROBO DE VEHÍCULO SIN VIOLENCIA">
                        ROBO DE VEHÍCULO SIN VIOLENCIA
                      </option>
                      <option value="ROBO EN VEHÍCULO DE PARTICULARES CON VIOLENCIA">
                        ROBO EN VEHÍCULO DE PARTICULARES CON VIOLENCIA
                      </option>
                      <option value="ROBO DE VEHÍCULO CON VIOLENCIA">
                        ROBO DE VEHÍCULO CON VIOLENCIA
                      </option>
                      <option value="ROBO A TRANSEÚNTE CON VIOLENCIA">
                        ROBO A TRANSEÚNTE CON VIOLENCIA
                      </option>
                      <option value="ROBO EN TRANSPORTE DE SERVICIO PÚBLICO COLECTIVO CON VIOLENCIA">
                        ROBO EN TRANSPORTE DE SERVICIO PÚBLICO COLECTIVO CON
                        VIOLENCIA
                      </option>
                      <option value="ROBO DE ENERGÍA ELÉCTRICA SIN VIOLENCIA">
                        ROBO DE ENERGÍA ELÉCTRICA SIN VIOLENCIA
                      </option>
                      <option value="ROBO A PERSONA EN LUGAR PRIVADO SIN VIOLENCIA">
                        ROBO A PERSONA EN LUGAR PRIVADO SIN VIOLENCIA
                      </option>
                      <option value="ROBO EN AUTOBUSES CON VIOLENCIA">
                        ROBO EN AUTOBUSES CON VIOLENCIA
                      </option>
                      <option value="ROBO DE ENERGÍA ELÉCTRICA CON VIOLENCIA">
                        ROBO DE ENERGÍA ELÉCTRICA CON VIOLENCIA
                      </option>
                      <option value="ROBO OTRO TIPO CON VIOLENCIA">
                        ROBO OTRO TIPO CON VIOLENCIA
                      </option>
                      <option value="ROBO A CUENTAHABIENTE CON VIOLENCIA">
                        ROBO A CUENTAHABIENTE CON VIOLENCIA
                      </option>
                      <option value="ROBO A TRANSEUNTE EN ESPACIO ABIERTO AL PUBLICO SIN VIOLENCIA">
                        ROBO A TRANSEUNTE EN ESPACIO ABIERTO AL PUBLICO SIN
                        VIOLENCIA
                      </option>
                      <option value="ROBO DE CAMIONES DE CARGA CON VIOLENCIA">
                        ROBO DE CAMIONES DE CARGA CON VIOLENCIA
                      </option>
                      <option value="ROBO A INSTITUCIONES DE SALUD SIN VIOLENCIA">
                        ROBO A INSTITUCIONES DE SALUD SIN VIOLENCIA
                      </option>
                      <option value="ROBO DE AUTOPARTES SIN VIOLENCIA">
                        ROBO DE AUTOPARTES SIN VIOLENCIA
                      </option>
                      <option value="ROBO DE HIDROCARBURO CON VIOLENCIA">
                        ROBO DE HIDROCARBURO CON VIOLENCIA
                      </option>
                      <option value="ROBO A INSTITUCIONES BANCARIAS CON VIOLENCIA">
                        ROBO A INSTITUCIONES BANCARIAS CON VIOLENCIA
                      </option>
                      <option value="ROBO EN TRANSPORTE DE SERVICIO PÚBLICO INDIVIDUAL CON VIOLENCIA">
                        ROBO EN TRANSPORTE DE SERVICIO PÚBLICO INDIVIDUAL CON
                        VIOLENCIA
                      </option>
                      <option value="ROBO A TRANSPORTISTAS SIN VIOLENCIA">
                        ROBO A TRANSPORTISTAS SIN VIOLENCIA
                      </option>
                      <option value="ROBO A VEHÍCULO SIN VIOLENCIA">
                        ROBO A VEHÍCULO SIN VIOLENCIA
                      </option>
                      <option value="ROBO A IGLESIAS CON VIOLENCIA">
                        ROBO A IGLESIAS CON VIOLENCIA
                      </option>
                      <option value="ROBO A TRANSEÚNTE EN VÍA PUBLICA CON VIOLENCIA">
                        ROBO A TRANSEÚNTE EN VÍA PUBLICA CON VIOLENCIA
                      </option>
                      <option value="DAÑO EN LA PROPIEDAD NO ESPECIFICADO">
                        DAÑO EN LA PROPIEDAD NO ESPECIFICADO
                      </option>
                      <option value="DAÑO EN LA PROPIEDAD CULPOSO">
                        DAÑO EN LA PROPIEDAD CULPOSO
                      </option>
                      <option value="DAÑO EN LA PROPIEDAD OTRO TIPO">
                        DAÑO EN LA PROPIEDAD OTRO TIPO
                      </option>
                      <option value="DAÑO EN LA PROPIEDAD DOLOSO">
                        DAÑO EN LA PROPIEDAD DOLOSO
                      </option>
                      <option value="INCUMPLIMIENTO DE UN DEBER LEGAL">
                        INCUMPLIMIENTO DE UN DEBER LEGAL
                      </option>
                      <option value="VIOLACIÓN A LA INTIMIDAD SEXUAL">
                        VIOLACIÓN A LA INTIMIDAD SEXUAL
                      </option>
                      <option value="PELIGRO DE CONTAGIO DE ENFERMEDADES">
                        PELIGRO DE CONTAGIO DE ENFERMEDADES
                      </option>
                      <option value="INTIMIDACIÓN">INTIMIDACIÓN</option>
                      <option value="EJERCICIO INDEBIDO DEL PROPIO DERECHO">
                        EJERCICIO INDEBIDO DEL PROPIO DERECHO
                      </option>
                      <option value="REBELIÓN">REBELIÓN</option>
                      <option value="SABOTAJE">SABOTAJE</option>
                      <option value="DESAPARICIÓN DE PERSONAS COMETIDAS POR PARTICULARES">
                        DESAPARICIÓN DE PERSONAS COMETIDAS POR PARTICULARES
                      </option>
                      <option value="TRÁFICO DE MENORES">
                        TRÁFICO DE MENORES
                      </option>
                      <option value="RECEPTACIÓN">RECEPTACIÓN</option>
                      <option value="TRATA DE PERSONAS CON FINES DE EXPLOTACIÓN SEXUAL">
                        TRATA DE PERSONAS CON FINES DE EXPLOTACIÓN SEXUAL
                      </option>
                      <option value="TRATA DE PERSONAS CON FINES DE TRABAJO O SERVICIOS FORZADOS">
                        TRATA DE PERSONAS CON FINES DE TRABAJO O SERVICIOS
                        FORZADOS
                      </option>
                      <option value="TRATA DE PERSONAS CON FINES DE TRAFICO DE ORGANOS">
                        TRATA DE PERSONAS CON FINES DE TRAFICO DE ORGANOS
                      </option>
                      <option value="TRATA DE PERSONAS CON OTROS FINES DE EXPLOTACION">
                        TRATA DE PERSONAS CON OTROS FINES DE EXPLOTACION
                      </option>
                      <option value="TRATA DE PERSONAS NO ESPECIFICADO">
                        TRATA DE PERSONAS NO ESPECIFICADO
                      </option>
                      <option value="ABANDONADO DE INCAPAZ">
                        ABANDONADO DE INCAPAZ
                      </option>
                      ...
                      <option value="DELITOS ELECTORALES COMETIDOS POR PARTICULARES">
                        DELITOS ELECTORALES COMETIDOS POR PARTICULARES
                      </option>
                      <option value="DELITOS ELECTORALES COMETIDOS POR SERVIDORES PÚBLICOS">
                        DELITOS ELECTORALES COMETIDOS POR SERVIDORES PÚBLICOS
                      </option>
                      <option value="DELITOS ELECTORALES COMETIDOS POR FUNCIONARIOS ELECTORALES">
                        DELITOS ELECTORALES COMETIDOS POR FUNCIONARIOS
                        ELECTORALES
                      </option>
                      <option value="DELITOS ELECTORALES COMETIDOS POR FUNCIONARIOS PARTIDISTAS">
                        DELITOS ELECTORALES COMETIDOS POR FUNCIONARIOS
                        PARTIDISTAS
                      </option>
                      <option value="CALUMNIA (DEROGADO)">
                        CALUMNIA (DEROGADO)
                      </option>
                      <option value="BIGAMIA">BIGAMIA</option>
                      <option value="ABIGEATO CON VIOLENCIA">
                        ABIGEATO CON VIOLENCIA
                      </option>
                      <option value="ABIGEATO SIN VIOLENCIA">
                        ABIGEATO SIN VIOLENCIA
                      </option>
                      <option value="EXTORSIÓN COMETIDA POR VÍA TELEFÓNICA O CUALQUIER OTRO MEDIO ELECTRÓNICO O DE COMUNICACIÓN">
                        EXTORSIÓN COMETIDA POR VÍA TELEFÓNICA O CUALQUIER OTRO
                        MEDIO ELECTRÓNICO O DE COMUNICACIÓN
                      </option>
                      <option value="EXTORSIÓN OTRO TIPO">
                        EXTORSIÓN OTRO TIPO
                      </option>
                      <option value="EXTORSIÓN NO ESPECIFICADO">
                        EXTORSIÓN NO ESPECIFICADO
                      </option>
                      <option value="FEMINICIDIO">FEMINICIDIO</option>
                      <option value="DESAPARICIÓN DE PERSONAS">
                        DESAPARICIÓN DE PERSONAS
                      </option>
                      <option value="TORTURA">TORTURA</option>
                      <option value="EJERCICIO INDEBIDO DEL SERVICIO PÚBLICO">
                        EJERCICIO INDEBIDO DEL SERVICIO PÚBLICO
                      </option>
                      <option value="ENCUBRIMIENTO">ENCUBRIMIENTO</option>
                      <option value="INCUMPLIMIENTO DE LAS OBLIGACIONES ALIMENTARIAS">
                        INCUMPLIMIENTO DE LAS OBLIGACIONES ALIMENTARIAS
                      </option>
                      <option value="ALTERACIÓN DE LA IMAGEN URBANA">
                        ALTERACIÓN DE LA IMAGEN URBANA
                      </option>
                      <option value="COALICIÓN DE SERVIDORES PÚBLICOS">
                        COALICIÓN DE SERVIDORES PÚBLICOS
                      </option>
                      <option value="SIMULACIÓN DE SECUESTRO">
                        SIMULACIÓN DE SECUESTRO
                      </option>
                      <option value="USO ILÍCITO DE ATRIBUCIONES Y FACULTADES">
                        USO ILÍCITO DE ATRIBUCIONES Y FACULTADES
                      </option>
                      <option value="NEGOCIACIONES INDEBIDAS">
                        NEGOCIACIONES INDEBIDAS
                      </option>
                      <option value="PUESTA A DISPOSICIÓN DE VEHÍCULO CON ALTERACIÓN EN SUS MEDIOS DE IDENTIFICACIÓN">
                        PUESTA A DISPOSICIÓN DE VEHÍCULO CON ALTERACIÓN EN SUS
                        MEDIOS DE IDENTIFICACIÓN
                      </option>
                      <option value="PUESTA A DISPOSICIÓN DE VEHÍCULO CON HUELLAS DE DESVALIGAMIENTO">
                        PUESTA A DISPOSICIÓN DE VEHÍCULO CON HUELLAS DE
                        DESVALIGAMIENTO
                      </option>
                      <option value="PUESTA A DISPOSICIÓN DE VEHÍCULO CON REPORTE DE ROBO">
                        PUESTA A DISPOSICIÓN DE VEHÍCULO CON REPORTE DE ROBO
                      </option>
                      <option value="PUESTA A DISPOSICIÓN DE VEHÍCULO POR OTROS HECHOS">
                        PUESTA A DISPOSICIÓN DE VEHÍCULO POR OTROS HECHOS
                      </option>
                      <option value="TRÁFICO DE INFLUENCIA">
                        TRÁFICO DE INFLUENCIA
                      </option>
                      <option value="INCUMPLIMIENTO DE PENAS NO PRIVATIVAS DE LIBERTAD Y MEDIDAS DE SEGURIDAD">
                        INCUMPLIMIENTO DE PENAS NO PRIVATIVAS DE LIBERTAD Y
                        MEDIDAS DE SEGURIDAD
                      </option>
                      <option value="PECULADO">PECULADO</option>
                      <option value="DELITOS COMETIDOS POR LOS SERVIDORES PÚBLICOS">
                        DELITOS COMETIDOS POR LOS SERVIDORES PÚBLICOS
                      </option>
                      <option value="ALLANAMIENTO DE MORADA">
                        ALLANAMIENTO DE MORADA
                      </option>
                      <option value="INSTIGACIÓN O AYUDA AL SUICIDIO">
                        INSTIGACIÓN O AYUDA AL SUICIDIO
                      </option>
                      <option value="EVASIÓN DE PRESOS">
                        EVASIÓN DE PRESOS{" "}
                      </option>
                      <option value="DELITOS CONTRA LA IDENTIDAD TERRITORIAL DEL ESTADO">
                        DELITOS CONTRA LA IDENTIDAD TERRITORIAL DEL ESTADO
                      </option>
                      <option value="PELIGRO DE DEVASTACIÓN">
                        PELIGRO DE DEVASTACIÓN
                      </option>
                      <option value="USURPACIÓN DE PROFESIONES">
                        USURPACIÓN DE PROFESIONES
                      </option>
                      <option value="ATAQUES A LAS VÍAS DE COMUNICACIÓN Y A LOS MEDIOS DE TRANSPORTE">
                      ...
                      <option value="PROMOCIÓN DE CONDUCTAS ILÍCITAS">
                        PROMOCIÓN DE CONDUCTAS ILÍCITAS
                      </option>
                      <option value="TERRORISMO">TERRORISMO</option>
                      <option value="DELITOS CONTRA EL AMBIENTE">
                        DELITOS CONTRA EL AMBIENTE
                      </option>
                      <option value="COBRANZA EXTRAJUDICIAL ILEGAL">
                        COBRANZA EXTRAJUDICIAL ILEGAL
                      </option>
                      <option value="FACILITACIÓN DELICTIVA">
                        FACILITACIÓN DELICTIVA
                      </option>
                      <option value="SEDICIÓN Y OTROS DESORDENES PÚBLICOS">
                        SEDICIÓN Y OTROS DESORDENES PÚBLICOS
                      </option>
                      <option value="AMENAZAS">AMENAZAS</option>
                      <option value="MATRIMONIO ILEGAL">
                        MATRIMONIO ILEGAL
                      </option>
                      <option value="DESPOJO">DESPOJO</option>
                      <option value="DELITOS CONTRA LA RIQUEZA FORESTAL">
                        DELITOS CONTRA LA RIQUEZA FORESTAL
                      </option>
                      <option value="RAPTO">RAPTO</option>
                      <option value="USURPACIÓN DE FUNCIONES PÚBLICAS Y EN MATERIA DE SERVICIOS DE SEGURIDAD PRIVADA Y USO INDEBIDO DE UNIFORMES, CONDECORACIONES Y ADITAMENTOS PROPIOS DE FUNCIONES POLICIALES">
                        USURPACIÓN DE FUNCIONES PÚBLICAS Y EN MATERIA DE
                        SERVICIOS DE SEGURIDAD PRIVADA Y USO INDEBIDO DE
                        UNIFORMES, CONDECORACIONES Y ADITAMENTOS PROPIOS DE
                        FUNCIONES POLICIALES
                      </option>
                      <option value="SECUESTRO GENÉRICO">
                        SECUESTRO GENÉRICO
                      </option>
                      <option value="SECUESTRO OTRO TIPO">
                        SECUESTRO OTRO TIPO
                      </option>
                      <option value="SECUESTRO CON CALIDAD DE REHÉN">
                        SECUESTRO CON CALIDAD DE REHÉN
                      </option>
                      <option value="SECUESTRO PARA CAUSAR DAÑO">
                        SECUESTRO PARA CAUSAR DAÑO
                      </option>
                      <option value="SECUESTRO EXPRÉS (POR EXTORSIÓN Y ROBO)">
                        SECUESTRO EXPRÉS (POR EXTORSIÓN Y ROBO)
                      </option>
                      <option value="COHECHO">COHECHO</option>
                      <option value="ABUSO SEXUAL">ABUSO SEXUAL</option>
                      <option value="FALSIFICACIÓN DE DOCUMENTOS Y USO DE DOCUMENTOS FALSOS">
                        FALSIFICACIÓN DE DOCUMENTOS Y USO DE DOCUMENTOS FALSOS
                      </option>
                      <option value="DISTRACCIÓN DE RECURSOS PÚBLICOS">
                        DISTRACCIÓN DE RECURSOS PÚBLICOS
                      </option>
                      <option value="VIOLACIÓN DE CORRESPONDENCIA">
                        VIOLACIÓN DE CORRESPONDENCIA
                      </option>
                      <option value="USO ILÍCITO DE ATRIBUCIONES Y FACULTADES RELACIONADO CON PARTICULARES">
                        USO ILÍCITO DE ATRIBUCIONES Y FACULTADES RELACIONADO CON
                        PARTICULARES
                      </option>
                      <option value="DIFAMACION (DEROGADO)">
                        DIFAMACION (DEROGADO)
                      </option>
                      <option value="INFIDELIDAD DE LA CUSTODIA DE DOCUMENTOS Y VIOLACIÓN DE SECRETOS">
                        INFIDELIDAD DE LA CUSTODIA DE DOCUMENTOS Y VIOLACIÓN DE
                        SECRETOS
                      </option>
                      <option value="EMBARAZO NO DESEADO A TRAVÉS DE MEDIOS CLÍNICOS, ESTERILIDAD PROVOCADA Y DISPOSICIÓN DE ÓVULOS O ESPERMAS SIN CONSENTIMIENTO">
                      ...
                      <option value="DESOBEDIENCIA Y RESISTENCIA DE PARTICULARES">
                        DESOBEDIENCIA Y RESISTENCIA DE PARTICULARES
                      </option>
                      <option value="INCESTO">INCESTO</option>
                      <option value="CORRUPCIÓN DE MENORES">
                        CORRUPCIÓN DE MENORES
                      </option>
                      <option value="IMPUTACIÓN DE HECHOS FALSOS Y SIMULACIÓN DE PRUEBAS">
                        IMPUTACIÓN DE HECHOS FALSOS Y SIMULACIÓN DE PRUEBAS
                      </option>
                      <option value="USO INDEBIDO DE LOS SISTEMAS DE EMERGENCIA">
                        USO INDEBIDO DE LOS SISTEMAS DE EMERGENCIA
                      </option>
                      <option value="CONCUSIÓN">CONCUSIÓN</option>
                      <option value="FALSEDAD ANTE LA AUTORIDAD">
                        FALSEDAD ANTE LA AUTORIDAD
                      </option>
                      <option value="ENRIQUECIMIENTO ILÍCITO">
                        ENRIQUECIMIENTO ILÍCITO
                      </option>
                      <option value="NARCOMENUDEO POR POSESION SIMPLE">
                        NARCOMENUDEO POR POSESION SIMPLE
                      </option>
                      <option value="NARCOMENUDEO NO ESPECIFICADO">
                        NARCOMENUDEO NO ESPECIFICADO
                      </option>
                      <option value="NARCOMENUDEO POR SUMINISTRO">
                        NARCOMENUDEO POR SUMINISTRO
                      </option>
                      <option value="NARCOMENUDEO OTROS DELITOS CONTRA LA SALUD RELACIONADOS CON NARCOTICOS">
                        NARCOMENUDEO OTROS DELITOS CONTRA LA SALUD RELACIONADOS
                        CON NARCOTICOS
                      </option>
                      <option value="NARCOMENUDEO POR COMERCIO">
                        NARCOMENUDEO POR COMERCIO
                      </option>
                      <option value="APROVECHAMIENTO SEXUAL">
                        APROVECHAMIENTO SEXUAL
                      </option>
                      <option value="ADMINISTRACIÓN FRAUDULENTA">
                        ADMINISTRACIÓN FRAUDULENTA
                      </option>
                      <option value="USURPACIÓN DE IDENTIDAD">
                        USURPACIÓN DE IDENTIDAD
                      </option>
                      <option value="DELITOS CONTRA EL COMERCIO, LA INDUSTRIA, LA AGRICULTURA Y LA ESTABILIDAD ECONÓMICA">
                        DELITOS CONTRA EL COMERCIO, LA INDUSTRIA, LA AGRICULTURA
                        Y LA ESTABILIDAD ECONÓMICA
                      </option>
                      <option value="DELITOS COMETIDOS POR LOS FRACCIONADORES">
                        DELITOS COMETIDOS POR LOS FRACCIONADORES
                      </option>
                      <option value="ESTUPRO">ESTUPRO</option>
                      <option value="CONSPIRACIÓN">CONSPIRACIÓN</option>
                      <option value="PRIVACIÓN ILEGAL DE LA LIBERTAD">
                        PRIVACIÓN ILEGAL DE LA LIBERTAD
                      </option>
                      <option value="QUEBRANTAMIENTOS DE SELLOS">
                        QUEBRANTAMIENTOS DE SELLOS
                      </option>
                      <option value="ABUSO DE CONFIANZA">
                        ABUSO DE CONFIANZA
                      </option>
                      <option value="APROVECHAMIENTO INDEBIDO DE BIENES EJIDALES O COMUNALES">
                        APROVECHAMIENTO INDEBIDO DE BIENES EJIDALES O COMUNALES
                      </option>
                      <option value="ULTRAJES A LA MORAL">
                        ULTRAJES A LA MORAL
                      </option>
                      <option value="LO QUE RESULTE DE LA MUERTE">
                        LO QUE RESULTE DE LA MUERTE
                      </option>
                      <option value="HECHOS POSIBLEMENTE CONSTITUTIVOS DEL DELITO">
                        HECHOS POSIBLEMENTE CONSTITUTIVOS DEL DELITO
                      </option>
                      <option value="ULTRAJES A LA AUTORIDAD">
                        ULTRAJES A LA AUTORIDAD
                      </option>
                      <option value="SUSTRACCIÓN DE MENORES E INCAPACES">
                        SUSTRACCIÓN DE MENORES E INCAPACES
                      </option>
                      <option value="FRAUDE">FRAUDE</option>
                      <option value="FRAUDE PROCESAL">FRAUDE PROCESAL</option>
                      <option value="FALSIFICACIÓN Y USO INDEBIDO DE SELLOS, MARCAS, LLAVES, CONTRASEÑAS Y OTROS OBJETOS">
                        FALSIFICACIÓN Y USO INDEBIDO DE SELLOS, MARCAS, LLAVES,
                        CONTRASEÑAS Y OTROS OBJETOS
                      </option>
                      <option value="OMISIÓN DE AUXILIO">
                        OMISIÓN DE AUXILIO
                      </option>
                      <option value="MOTÍN">MOTÍN</option>
                      <option value="DELITOS DE ABOGADOS, DEFENSORES Y LITIGANTES">
                        DELITOS DE ABOGADOS, DEFENSORES Y LITIGANTES
                      </option>
                      <option value="DELITOS COMETIDOS EN MATERIA DE PROTECCIÓN CIVIL">
                        DELITOS COMETIDOS EN MATERIA DE PROTECCIÓN CIVIL
                      </option>
                      <option value="DELITOS CONTRA LA FILIACIÓN Y EL ESTADO FAMILIAR DE LAS PERSONAS">
                        DELITOS CONTRA LA FILIACIÓN Y EL ESTADO FAMILIAR DE LAS
                        PERSONAS
                      </option>
                      <option value="VIOLACIÓN SIMPLE">VIOLACIÓN SIMPLE</option>
                      <option value="VIOLACIÓN EQUIPARADA">
                        VIOLACIÓN EQUIPARADA
                      </option>
                      <option value="LENOCINIO">LENOCINIO</option>
                      <option value="DESAPARICIÓN FORZADA DE PERSONAS">
                  ...
                  <div className="form-group mb-3">
                    <input
                      ...
                      type="time"
                      className="form-control"
                      placeholder="Hora del suceso (24hrs)"
                      id="timeHoraSuceso"
                      name="timeHoraSuceso"
                      value={this.state.timeHoraSuceso}
                      ref={(timeHoraSuceso) =>
                        (this.inputTimeHoraSuceso = timeHoraSuceso)
                      }
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    <input
                      ...
                      name="dateFSuceso"
                      value={this.state.dateFSuceso}
                      ref={(dateFSuceso) =>
                        (this.inputDateFSuceso = dateFSuceso)
                      }
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    <input
                      ...
                      id="txtCalle"
                      name="txtCalle"
                      value={this.state.txtCalle}
                      type="text"
                      className="form-control"
                      placeholder="Calle"
                      ref={(txtCalle) => (this.inputTxtCalle = txtCalle)}
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    <input
                      ...
                      id="txtNumInt"
                      name="txtNumInt"
                      value={this.state.txtNumInt}
                      type="text"
                      className="form-control"
                      placeholder="Numero interior"
                      ref={(txtNumInt) => (this.inputTxtNumInt = txtNumInt)}
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    <input
                      ...
                      id="txtNumExt"
                      name="txtNumExt"
                      value={this.state.txtNumExt}
                      type="text"
                      className="form-control"
                      placeholder="Numero exterior"
                      ref={(txtNumExt) => (this.inputTxtNumExt = txtNumExt)}
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    <input
                      ...
                      id="txtEntCalle1"
                      name="txtEntCalle1"
                      value={this.state.txtEntCalle1}
                      type="text"
                      className="form-control"
                      placeholder="Entre calle 1"
                      ref={(txtEntCalle1) =>
                        (this.inputTxtEntCalle1 = txtEntCalle1)
                      }
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    <input
                      ...
                      id="txtEntCalle2"
                      name="txtEntCalle2"
                      value={this.state.txtEntCalle2}
                      type="text"
                      className="form-control"
                      placeholder="Entre calle 2"
                      ref={(txtEntCalle2) =>
                        (this.inputTxtEntCalle2 = txtEntCalle2)
                      }
                    />
                  </div>
                  ...
                  <div className="form-group mb-3">
                    <input
                      ...
                      id="txtReferencias"
                      name="txtReferencias"
                      value={this.state.txtReferencias}
                      type="text"
                      className="form-control"
                      placeholder="Referencias"
                      ref={(txtReferencias) =>
                        (this.inputTxtReferencias = txtReferencias)
                      }
                    />
                  </div>
                </div>
                ...
                <div className="col-md-6">
                  ...
                  <div className="form-group mb-3">
                    <input
                      ...
                      name="txtLatitud"
                      placeholder="Latitud"
                      value={this.state.txtLatitud}
                      ref={(txtLatitud) => (this.inputTxtLatitud = txtLatitud)}
                    />
                    <input
                      onChange={this.handlerOnChange}
                      type="text"
                      ...
                      value={this.state.txtLongitud}
                      ref={(txtLongitud) =>
                        (this.inputTxtLongitud = txtLongitud)
                      }
                    />
                  </div>
                </div>
